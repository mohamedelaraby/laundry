...
class ReportInvoicesDatatable extends DataTable implements BaseDatatableInterface
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('actions', 'reports.Invoices.btn.actions')
            ->rawColumns(['actions'])
    ...
    public function getColumns()
    {
        return [
            ...
            [
                'data' => 'name',
                'name' => 'name',
                'title' => trans('admin.Invoice_name')
            ],
            [
                'data' => 'created_at',
                'name' => 'created_at',
