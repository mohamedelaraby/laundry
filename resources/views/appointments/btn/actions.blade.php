<a  class="btn btn-info mb-3" href="appointments/edit/{{$id}}">
  ...
  <div class="modal fade" id="del_admin{{ $id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        {{--  Start Delete form --}}
        {!! Form::open(['route'=>['admins.appointments.destroy',$id],'method'=>'POST']) !!}
        <div class="modal-body">
            {{ csrf_field() }}
            {!! Form::hidden('_method','delete') !!}
        <h4>{{trans('admin.delete_this',['name'=>$due_at])}}</h4>
        </div>
